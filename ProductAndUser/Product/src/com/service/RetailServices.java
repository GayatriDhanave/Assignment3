...
import java.util.*;
 ...
 public class RetailServices implements ServiceInterface{

     static List<Product> productList=new ArrayList<>();
     static {
         productList.add(new Product(101, "Mobile", 1, 20000));
         productList.add(new Product(102,"Laptop", 1, 60000));
         productList.add(new Product(103,"HeadPhones", 1, 2000));
         productList.add(new Product(104,"PowerBank", 1, 5000));
         productList.add(new Product(105,"MobileCharger", 1, 500));
    ...
    public void addProduct () {
        ...
        public void removeProduct () {
            ...
            String prodname = scanner.next();
            if (productSet != null) {
                productSet.removeIf(product -> product.getName().equals(prodname));
